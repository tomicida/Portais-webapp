...
public class Reiki extends SubFerramenta{
    public Reiki(Ferramenta mainFerramenta){
        super(mainFerramenta, "Reiki");
        ...
        intermedFerramenta = new SubFerramenta(mainFerramenta, "Principio");
        ...
        intermedFerramenta.repeatString = "principio (index reiki) para (ação), ";
        ...
        intermedFerramenta = new SubFerramenta(mainFerramenta, "Símbolo");
        intermedFerramenta.multi = true;
