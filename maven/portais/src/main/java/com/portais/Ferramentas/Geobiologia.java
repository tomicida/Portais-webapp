...
public class Geobiologia extends SubFerramenta{
    public Geobiologia(Ferramenta mainFerramenta){
        ...
        intermedFerramenta.ações.add("Transmutar a informação espaço- mainFerramentaoral com a frequência da cor violeta");
        ...
        intermedFerramenta.ações.add("Ativar as frequências das Geometrias Phtah, Exodin e Labirinto de Amiens para limpeza, reestruturação, equilíbrio e proteção do espaço-mainFerramentao e de Programador Físico e Multioscilador para imprimir o estado de equilíbrio de saúde nos envolvidos com a anomalia do campo mórfico.");
        intermedFerramenta.ações.add("Ativar as frequências das Geometrias Phtah, Exodin e Labirinto de Amiens para limpeza, reestruturação, equilíbrio e proteção do espaço-mainFerramentao e de Programador Físico e Multioscilador para imprimir o estado de equilíbrio de saúde nos envolvidos com a anomalia do campo mórfico.");
        intermedFerramenta.ações.add("Ativar as frequências das Geometrias Phtah, Exodin e Labirinto de Amiens para limpeza, reestruturação, equilíbrio e proteção do espaço-mainFerramentao e de Programador Físico e Multioscilador para imprimir o estado de equilíbrio de saúde nos envolvidos com a anomalia do campo mórfico.");
        intermedFerramenta.ações.add("Ativar as frequências das Geometrias Phtah, Exodin e Labirinto de Amiens para limpeza, reestruturação, equilíbrio e proteção do espaço-mainFerramentao e de Programador Físico e Multioscilador para imprimir o estado de equilíbrio de saúde nos envolvidos com a anomalia do campo mórfico.");
        intermedFerramenta.ações.add("Ativar as frequências das Geometrias Phtah, Exodin e Labirinto de Amiens para limpeza, reestruturação, equilíbrio e proteção do espaço-mainFerramentao e de Programador Físico e Multioscilador para imprimir o estado de equilíbrio de saúde nos envolvidos com a anomalia do campo mórfico.");
