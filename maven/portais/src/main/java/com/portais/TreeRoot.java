...
public class TreeRoot {
    ...
    public TreeRoot(){
        ...
        subTemp.ações.add("Atua no desenvolvimento ósseo, na visão, na boa formação da pele, na imunidade e na reprodução, além de ser anticancerígeno.");
        subTemp.ações.add("Auxilia no metabolismo dos carboidratos, das gorduras e proteínas; atua na musculatura e na respiração dos tecidos.");
        subTemp.ações.add("Importante para o metabolismo dos carboidratos, das gorduras e proteínas, para a conservação dos tecidos, para os olhos e também para a manutenção da pele.");
        subTemp.ações.add("Tem indicação para o nervosismo, depressão, estresse, problemas digestivos, pelagra, insônia, problemas de pele (acne, erupções).");
        subTemp.ações.add("Por ajudar no metabolismo dos aminoácidos e das proteínas, é importante para o crescimento.");
        subTemp.ações.add("Essencial para o bom funcionamento das células, principalmente as do trato gastrointestinal, da medula óssea e do tecido nervoso.");
        ...
        subTemp.ações.add("Essencial para a formação da estrutura óssea e dos dentes.");
        subTemp.ações.add("Antioxidante, atua na manutenção do tecido epitelial e auxilia no metabolismo das gorduras e no bom aproveitamento da vitamina A.");
        subTemp.ações.add("Serve para combater hemorragias nasais, da pele e lesões no fígado.");
        subTemp.ações.add("Acelera a cicatrização das úlceras no estômago, duodeno e intestino.");
        subTemp.ações.add("É de grande importância no processo de divisão das hemácias, os glóbulos vermelhos do sangue. Também é responsável por unhas, cabelos e medula óssea, e pelo bom funcionamento do sistema imunológico.");
        subTemp.ações.add("Importante no metabolismo energético auxilia na reposição dos tecidos corporais.");
        subTemp.ações.add("Fundamental para o crescimento e importante na construção e na manutenção de ossos e dentes.");
        subTemp.ações.add("Previne a anemia por ser um nutriente importante na formação das células vermelhas. Também favorece o crescimento e a vitalidade.");
        subTemp.ações.add("Combate o estresse e as alterações do sistema nervoso.");
        subTemp.ações.add("Serve para deficiência no desenvolvimento físico e mental, cansaço e fraqueza.");
        subTemp.ações.add("Trabalha junto com o fósforo para fixar o cálcio nos ossos e dentes. Além disso, é ele que permite que o corpo relaxe depois de uma contração. O bom funcionamento dos nervos e músculos também depende dele.");
        subTemp.ações.add("Além de aprimorar os reflexos dos músculos, ajuda a combater o cansaço e a fadiga.");
        subTemp.ações.add("Ajuda a levar oxigênio para as células.");
        subTemp.ações.add("É um dos responsáveis pelos batimentos do coração, pela normalidade da pressão sanguínea e pelas contrações dos músculos.");
        ...
        subSubTemp.ações.add("Controlar a estimulação e os níveis do controle motor.");
        subSubTemp.ações.add("Estimular o humor, memória, aprendizado, alimentação, desejo sexual e sono reparador.");
        subSubTemp.ações.add("Promover as contrações musculares uterinas; reduzir o sangramento durante o parto, estimular a libertação do leite materno; desenvolver a empatia entre pessoas; e modelar a sensibilidade ao medo.");
        subSubTemp.ações.add("induzir a excitação física e mental e ao bom humor.");
        subSubTemp.ações.add("Preparar o organismo para a realização de grandes feitos, derivado da modificação de um aminoácido aromático (tirosina)");
        subSubTemp.ações.add("Potenciar a ação analgésica e estimular a sensação de bem-estar, conforto, melhor estado de humor e alegria, êxtase e euforia.");
        subSubTemp.ações.add("Ajudar a aumentar a pressão arterial estreitando os vasos sanguíneos do coração e do coração para o cérebro");
        //TODO Confirmar ação
