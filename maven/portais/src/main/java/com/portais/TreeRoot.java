...
public class TreeRoot {
    ...
    public TreeRoot(){
        ...
        //TODO confirmar ordem (missing 6)
        ...
        temp.subFerramentas.add(subTemp);
        //TODO confirmar decreto (empresa)
        ...
        subTemp.multi = true;
        subTemp.resultados.add("ABERTURA 'Eu abro meu coração para aspessoas ao meu redor.'");
        subTemp.resultados.add("ABUNDÂNCIA 'Eu valorizo o que tenho e estou receptivo para mais.'");
        subTemp.resultados.add("ACEITAÇÃO 'Eu aceito que a mudança precisa ser dividida em etapas.'");
        subTemp.resultados.add("ALEGRIA 'Eu vejo com humor o meu processo.'");
        subTemp.resultados.add("ALTIVEZ 'Eu me sinto digno de todas as escolhas que fiz.'");
        subTemp.resultados.add("AMOR INCONDICIONAL 'Eu me amo e estou autorizado a ser.'");
        subTemp.resultados.add("AMOR PRÓPRIO 'Eu me amo por quem eu sou.'");
        subTemp.resultados.add("ANCORAGEM 'Eu aproveito este momento para ancorar o meu crescimento.'");
        subTemp.resultados.add("AQUIESCÊNCIA 'Este é o tempo de fazer novas escolhas.'");
        subTemp.resultados.add("ASCENSÃO 'Eu sou o produtor da minha própria vida.'");
        subTemp.resultados.add("AUTENTICIDADE 'Eu sou um ser especial e único.'");
        subTemp.resultados.add("AUTOCONFIANÇA - SEGURANÇA EM SI MESMO 'Eu confio em mim mesmo e nas escolhas que faço.'");
        subTemp.resultados.add("AUTOCURA Eu posso me curar de tudo.'");
        subTemp.resultados.add("AUTO-ESTIMA 'Eu aprecio quem eu sou e o que faço.'");
        subTemp.resultados.add("AUTORREFLEXÃO 'Eu cresço por ser honesto comigo mesmo sobre o que tenho que mudar.'");
        subTemp.resultados.add("AVANÇO - DESCOBERTA 'Eu agora escolho pelo meu avanço.'");
        subTemp.resultados.add("CAPACITAÇÃO 'Eu tenho a força para realizar o meu sonho.'");
        subTemp.resultados.add("CHAMADA 'Eu faço as coisas que me dão força agora.'");
        subTemp.resultados.add("CHEGADA 'Eu tomo o caminho mais curto para o meu destino.'");
        subTemp.resultados.add("CICLO 'Eu estou começando do princípio de um novo ciclo.'");
        subTemp.resultados.add("CLAREZA 'Eu aponto claramente o que eu quero.'");
        subTemp.resultados.add("CO-CRIAÇÃO 'Eu e o outro somos um e unidos avançamos.'");
        subTemp.resultados.add("COMPAIXÃO 'Eu permito aos outros espaço para o processo deles.'");
        subTemp.resultados.add("COMUNICAÇÃO 'Eu levo a sério os sinais de meu corpo.'");
        subTemp.resultados.add("COMUTAÇÃO 'Eu sou eu mesmo em todas as situações.'");
        subTemp.resultados.add("CONEXÃO 'Eu me conecto à minha fonte interior de sabedoria.'");
        subTemp.resultados.add("CONFIRMAÇÃO 'O que eu penso e expresso hoje, será confirmado espontaneamente.'");
        subTemp.resultados.add("CONHECIMENTO 'Eu confio no conhecimento que está oculto em meu interior.'");
        subTemp.resultados.add("CONSCIÊNCIA 'Eu confio que há sempre auxílio quando eu necessito dele.'");
        subTemp.resultados.add("CONSCIÊNCIA CRÍSTICA 'Eu creio nos poderes divinos que eu possuo.'");
        subTemp.resultados.add("CONSCIÊNCIA DE UNIDADE 'Todos nós somos conectados uns aos outros.'");
        subTemp.resultados.add("CONSCIÊNCIA INTEGRAL OU DA TOTALIDADE 'Eu deixo de lado meu julgamento da situação.'");
        subTemp.resultados.add("CONTATO 'Eu faço contato consciente com qual lugar eu quero ir.'");
        subTemp.resultados.add("CONVERSÃO - TRANSMUTAÇÃO 'Eu me apodero de minha liberdade e crio a partir do coração.'");
        subTemp.resultados.add("CONVITE 'Eu aceito todos os convites para me desenvolver.'");
        subTemp.resultados.add("CRIAÇÃO 'Quanto mais estou limpo, mais posso criar tudo que quero.'");
        subTemp.resultados.add("CULPA 'Eu sou responsável apenas pelos meus próprios atos.'");
        subTemp.resultados.add("CURA 'Eu estou atraindo do espaço o que eu preciso para curar a minha dor.'");
        subTemp.resultados.add("DESAPEGO & LIVRAMENTO 'Eu me livro de tudo que restringe meu crescimento.'");
        subTemp.resultados.add("DESDOBRAMENTO 'Eu confio as escolhas que faço e aceito os seus frutos.'");
        subTemp.resultados.add("DESEJO 'Eu abraço meus desejos e ouso a admiti-los.'");
        subTemp.resultados.add("DESMASCARAR 'Eu ouso ser diferente do que é considerado normal.'");
        subTemp.resultados.add("DESPRENDIMENTO 'Eu deixo de lado tudo que me sobrecarrega.'");
        subTemp.resultados.add("DEVOÇÃO 'Eu sou dedicado a mim mesmo.'");
        subTemp.resultados.add("DIREÇÃO 'Eu escolho confiante minha própria direção.'");
        subTemp.resultados.add("DUALIDADE 'Eu libero todos os meus julgamentos.'");
        subTemp.resultados.add("ECO 'Eu percebo com clareza tanto o que transmito quanto o que recebo,através dos ecos da Alma.'");
        subTemp.resultados.add("ELEMENTO 'Eu nasci para o que faço.'");
        subTemp.resultados.add("EMERGÊNCIA 'Eu assumo o desafio de mostrar quem eu realmente sou.'");
        subTemp.resultados.add("ENTREGA 'Eu abro meu coração, entregando-me inteiramente a ele.'");
        subTemp.resultados.add("EQUILIBRIO 'Eu estou firme e equilibrado.'");
        subTemp.resultados.add("ESCOLHAS - CAPACIDADE DE ELEGER 'Eu aceito as consequências das escolhas que fiz.'");
        subTemp.resultados.add("ESSÊNCIA 'Confio na sabedoria de minha alma.'");
        subTemp.resultados.add("EXPANSÃO - DESENVOLVIMENTO 'Eu tenho tudo em mim para ser bem sucedido.'");
        subTemp.resultados.add("FÉ - CONFIANÇA 'Eu tenho fé no que sinto se aproximar.'");
        subTemp.resultados.add("FLUXO 'Eu entro nas ondas de minha criação.'");
        subTemp.resultados.add("FOCO 'Eu estou focado no que me faz feliz.'");
        subTemp.resultados.add("FREQUÊNCIA 'Eu estou emitindo minha própria frequência.'");
        subTemp.resultados.add("GRATIDÃO 'Eu sou grato por tudo que me fez ser quem eu sou.'");
        subTemp.resultados.add("HARMONIA 'Eu vivo em harmonia com meu Eu Interior e o meu ambiente.'");
        subTemp.resultados.add("ILUMINAÇÃO 'Tudo o que eu experimento me ajuda a ficar mais iluminado.'");
        subTemp.resultados.add("ILUSÃO 'Eu estou acima do meu medo da mudança.'");
        subTemp.resultados.add("IMPRESSÃO 'Eu prezo pelo que tenho alcançado até agora.'");
        subTemp.resultados.add("INFINITO 'Meu poder é grande e infinito.'");
        subTemp.resultados.add("INICIAÇÃO 'Eu vivo em liberdade.'");
        subTemp.resultados.add("INOCÊNCIA 'Eu estou autorizado a brincar livre como uma criança.'");
        subTemp.resultados.add("INTEGRAÇÃO 'Eu faço parte das lições da minha vida diariamente.'");
        subTemp.resultados.add("INTENÇÃO 'Eu levo minhas intenções a sério.'");
        subTemp.resultados.add("INTUIÇÃO 'Eu escuto meus sentimentos e ajo em direção a eles.'");
        subTemp.resultados.add("LEALDADE 'Eu sou leal a mim mesmo e ao que eu defendo.'");
        subTemp.resultados.add("LIBERAÇÃO 'Eu dou liberdade para a minha criança interior.'");
        subTemp.resultados.add("LIBERDADE 'Eu me dou a liberdade de Ser.'");
        subTemp.resultados.add("LIBERTAÇÃO 'Eu me liberto das críticas que faço sobre mim mesmo.'");
        subTemp.resultados.add("LIMITAÇÕES 'Eu continuo o que eu comecei.'");
        subTemp.resultados.add("MANIFESTAÇÃO 'Eu ouso manifestar o que eu realmente quero.'");
        subTemp.resultados.add("MESTRE 'Eu sou o que eu sou, livre para ser.'");
        subTemp.resultados.add("MOMENTUM 'Eu confio que, no momento certo, farei o que tenho que fazer.'");
        subTemp.resultados.add("MOVIMENTO 'Eu percorro meu caminho no meu próprio ritmo.'");
        subTemp.resultados.add("MUDANÇA - MOVIMENTO CONTÍNUO 'Eu me conecto com a energia do momento.'");
        subTemp.resultados.add("MUDANÇA DE TEMPO 'Eu tenho tempo suficiente para fazer tudo que eu quero.'");
        subTemp.resultados.add("NASCIMENTO 'Hoje eu saúdo meu novo Eu.'");
        subTemp.resultados.add("OPORTUNIDADES 'Eu tenho infinitas possibilidades para alcançar o sucesso.'");
        subTemp.resultados.add("OPOSTOS 'Eu renuncio a julgar.'");
        subTemp.resultados.add("PACIÊNCIA 'Eu estou deixando passar minhas expectativas e abrindo-me para aquil o que é possível receber.'");
        subTemp.resultados.add("PAIXÃO 'Se eu faço o que eu gosto de fazer, tudo dará certo.'");
        subTemp.resultados.add("PAZ 'Eu crio a paz em mim e na minha vida.'");
        subTemp.resultados.add("PERDÃO 'Eu me perdoo pelo que eu tenha gostado de fazer de forma diferente.'");
        subTemp.resultados.add("PERSEVERANÇA 'Eu sei o que eu quero e para onde vou.'");
        subTemp.resultados.add("PERSPECTIVA 'Eu posso transformar qualquer situação a meu favor.'");
        subTemp.resultados.add("PLANO DE VIDA 'Eu creio que minha alma tem acompanhado o plano de vida.'");
        subTemp.resultados.add("PLENITUDE 'Eu reconheço todas as minhas características, boas ou más.'");
        subTemp.resultados.add("PODER DE AÇÃO 'Eu converto meus planos em ações.'");
        subTemp.resultados.add("PONTO DE INFLEXÃO - MOMENTO CRUCIAL 'É hora de fazê-lo de forma diferente.'");
        subTemp.resultados.add("PRESENTE - DOM 'Eu reconheço meu dom sem igual.'");
        subTemp.resultados.add("PROCESSAMENTO 'Eu assimilo meu passado em paz e quietude.'");
        subTemp.resultados.add("PROFUNDO DESPERTAR 'Eu estou ciente do que me ajuda a avançar e do que me obstrui.'");
        subTemp.resultados.add("PROJETO 'Eu confio no plano que me trouxe até aqui.'");
        subTemp.resultados.add("PROTEÇÃO 'Eu estou emitindo minhas próprias frequências.'");
        subTemp.resultados.add("PUREZA 'Eu respondo aos outros com pureza.'");
        subTemp.resultados.add("PURIFICAÇÃO 'Eu me curo, tornando-me honesto comigo mesmo.'");
        subTemp.resultados.add("REALIZAÇÃO 'Eu percebo que posso criar o que eu quero.'");
        subTemp.resultados.add("RECONHECIMENTO 'Eu me concedo a oportunidade de cometer erros.'");
        subTemp.resultados.add("RECORDAÇÃO 'Eu me lembro para o que eu nasci.'");
        subTemp.resultados.add("REFINAMENTO 'Eu estou autorizado a desfrutar o meu processo de crescimento.'");
        subTemp.resultados.add("REFORMA 'Eu estou pronto para realizar a reforma interior que me libertará.'");
        subTemp.resultados.add("RENASCIMENTO 'Eu me desprendo de tudo o que é velho e me envolvo com o que é novo.'");
        subTemp.resultados.add("REPETIÇÃO 'Cada repetição é um novo desafio para crescer.'");
        subTemp.resultados.add("RESILIÊNCIA 'Eu também supero os deslizes e recaídas.'");
        subTemp.resultados.add("RESISTÊNCIA 'Eu faço o que eu realmente quero.'");
        subTemp.resultados.add("RETORNO FINAL 'Eu sou o mestre do meu próprio processo criativo.'");
        subTemp.resultados.add("REVELAÇÃO 'É hora de mostrar quem eu realmente sou.'");
        subTemp.resultados.add("RITMO 'Eu faço escolhas que ressoam com o ritmo da vida.'");
        subTemp.resultados.add("SABEDORIA 'A resposta para quem eu sou encontra-se dentro de mim.'");
        subTemp.resultados.add("SACRIFÍCIO 'Eu escolho conscientemente alcançar meu objetivo.'");
        subTemp.resultados.add("SATISFAÇÃO 'Eu aumento a qualidade da minha vida.'");
        subTemp.resultados.add("SEM LIMITES 'Meu poder é ilimitado.'");
        subTemp.resultados.add("SEMENTES 'Hoje eu planto as sementes de meus ideais.'");
        subTemp.resultados.add("SENSAÇÃO DE SEGURANÇA - BEM-ESTAR 'Eu preciso somente de mim para me sentir seguro.'");
        subTemp.resultados.add("SENSIBILIDADE 'Eu confio em minhas sensações e nos sinais que eu capto.'");
        subTemp.resultados.add("SEXUALIDADE 'Eu posso me dar amor.'");
        subTemp.resultados.add("SILÊNCIO 'Eu me conecto com o silêncio em meu coração.'");
        subTemp.resultados.add("SINCRONICIDADE 'Eu estou alerta aos símbolos que indicam o caminho.'");
        subTemp.resultados.add("SINERGIA 'Minha cabeça e coração são um.'");
        subTemp.resultados.add("TEMPO NATURAL 'Eu entro em sintonia com o ritmo da natureza.'");
        subTemp.resultados.add("TEMPO DE NASCER DE NOVO 'Eu me ofereço a uma nova chance.'");
        subTemp.resultados.add("TERCEIRA ONDA 'Eu me responsabilizo por um mundo melhor.'");
        subTemp.resultados.add("TRANSCENDÊNCIA 'Eu transcendo meus medos e limitações.'");
        subTemp.resultados.add("TRANSFIGURAÇÃO 'Eu aceito o desafio de mudar.'");
        subTemp.resultados.add("TRANSFORMAÇÃO 'Eu vou ao limite para realizar meu sonho.'");
        subTemp.resultados.add("TRANSIÇÃO 'Eu me entrego ao desconhecido.'");
        subTemp.resultados.add("UNIÃO 'Eu compartilho meu coração, porque eu sou um desbravador.'");
        subTemp.resultados.add("UNICIDADE 'O que eu penso e sinto são igualmente importantes.'");
        subTemp.resultados.add("VERDADE 'Minha verdade é fundamentada no que eu sinto.'");
        subTemp.resultados.add("VITÓRIA 'Eu vou fazê-lo!'");
        subTemp.resultados.add("VOZ INTERIOR 'Eu estou sempre ouvindo a sabedoria de meu coração.'");
        subTemp.resultados.add("VULNERABILIDADE 'Eu ouso mostrar minha vulnerabilidade.'");
        
        

        subTemp.repeatString = "<br/>Ativo agora o código (nº e designação) na frequência certa e na quantidade exata e ordeno que se fixe no campo morfogenético de (nome do consulente) operando a cura e a transformação interior em todos os corpos e todos os chakras. ";
        subTemp.ownDecreto = "Na divina presença do Eu Sou de (nome do terapeuta) abro a frequência do método de Cura Quântica Multidimensional pedindo ao Eu Superior de (nome do consulente) permissão para atuar no seu campo morfogenético com as frequências de Cura dos Códigos Arcturianos. Acedendo ao campo cósmico de comunicação estelar e ativando os aparelhos etéreos de aplicação dos códigos. (next) <br/>Encerro agora a comunicação com o campo cósmico de comunicação estelar e todos os aparelhos etéreos de aplicação. Fechando o campo morfogenético e a Merkabah Pessoal de (nome completo do consulente) e ordeno que se fixem todas as frequências de cura, agora.";
        temp.subFerramentas.add(subTemp);
        ...
        /*subTemp = new SubFerramenta(temp, "Tonificação das Funções Yin");

        subTemp.ownDecreto = "Na divina presença do Eu Sou de (nome do terapeuta) abro a frequência do método de Cura Quântica Multidimensional e a Matriz dos Meridianos Energéticos com a função de tonificar as funções Yin pedindo ao Eu Superior de (nome do consulente) permissão para atuar nos seus campos, chakras e corpos sutis. Ativo agora a frequência do ponto (ponto) na localização (localização). Que pulsem na harmonia e alinhamento de consciência de (nome do consulente) na quantidade certa e na medida exata. Pulsa no campo, pulsa no campo, pulsa no campo";

        subTemp.resultados.add("Fígado");
        subTemp.resultados.add("Coração");
        subTemp.resultados.add("Circ./Sex");
...
***
        ...
        subSubTemp.ações.add("F8");
        subSubTemp.ações.add("F1");
        subSubTemp.ações.add("F2");
        subSubTemp.ações.add("F3");
        subSubTemp.ações.add("F4");
        subSubTemp.ownDecreto = subTemp.ownDecreto;
        subTemp.subFerramentas.add(subSubTemp);
        ...
        subSubTemp.ações.add("C3");
        subSubTemp.ações.add("C9");
        subSubTemp.ações.add("C8");
        subSubTemp.ações.add("C7");
        subSubTemp.ações.add("C4");
        subSubTemp.ownDecreto = subTemp.ownDecreto;
        subTemp.subFerramentas.add(subSubTemp);

        subSubTemp = new SubFerramenta(temp, "Circ./Sex");
        subSubTemp.resultados.add("");
        subSubTemp.resultados.add("");
        subSubTemp.resultados.add("");
        subSubTemp.resultados.add("");
        ...
        subSubTemp.ações.add("CS3");
        subSubTemp.ações.add("CS9");
        subSubTemp.ações.add("CS8");
        subSubTemp.ações.add("CS7");
        subSubTemp.ações.add("CS5");
        subSubTemp.ownDecreto = subTemp.ownDecreto;
        subTemp.subFerramentas.add(subSubTemp);
        ...
        subSubTemp.ações.add("BP9");
        subSubTemp.ações.add("BP1");
        subSubTemp.ações.add("BP2");
        subSubTemp.ações.add("BP3");
        subSubTemp.ações.add("BP5");
        subSubTemp.ownDecreto = subTemp.ownDecreto;
        subTemp.subFerramentas.add(subSubTemp);
        ...
        subSubTemp.ações.add("P5");
        subSubTemp.ações.add("P11");
        subSubTemp.ações.add("P10");
        subSubTemp.ações.add("P9");
        subSubTemp.ações.add("P8");
        subSubTemp.ownDecreto = subTemp.ownDecreto;
        subTemp.subFerramentas.add(subSubTemp);
        ...
        subSubTemp.ações.add("R10");
        subSubTemp.ações.add("R1");
        subSubTemp.ações.add("R2");
        subSubTemp.ações.add("R3");
        subSubTemp.ações.add("R7");
        subSubTemp.ownDecreto = subTemp.ownDecreto;
        subTemp.subFerramentas.add(subSubTemp);

        temp.subFerramentas.add(subTemp);

        subTemp = new SubFerramenta(temp, "Sedação das Funções Yin");
        subTemp.ownDecreto = "Na divina presença do Eu Sou de (nome do terapeuta) abro a frequência do método de Cura Quântica Multidimensional e a Matriz dos Meridianos Energéticos com a função de sedar as funções Yin pedindo ao Eu Superior de (nome do consulente) permissão para atuar nos seus campos, chakras e corpos sutis. Ativo agora a frequência do ponto (ponto) na localização (localização). Que pulsem na harmonia e alinhamento de consciência de (nome do consulente) na quantidade certa e na medida exata. Pulsa no campo, pulsa no campo, pulsa no campo";
        ...
        subTemp = new SubFerramenta(temp, "Tonificação das Funções Yang");
        subTemp.ownDecreto = "Na divina presença do Eu Sou de (nome do terapeuta) abro a frequência do método de Cura Quântica Multidimensional e a Matriz dos Meridianos Energéticos com a função de tonificar as funções Yang pedindo ao Eu Superior de (nome do consulente) permissão para atuar nos seus campos, chakras e corpos sutis. Ativo agora a frequência do ponto (ponto) na localização (localização). Que pulsem na harmonia e alinhamento de consciência de (nome do consulente) na quantidade certa e na medida exata. Pulsa no campo, pulsa no campo, pulsa no campo";
        
        subTemp.resultados.add("Vesicula Biliar");
        ...
        subSubTemp = new SubFerramenta(temp, "Vesicula Biliar");
        subSubTemp.resultados.add("");
        subSubTemp.resultados.add("");
        subSubTemp.resultados.add("");
        subSubTemp.resultados.add("");
        ...
        subSubTemp.ações.add("VB43");
        subSubTemp.ações.add("VB41");
        subSubTemp.ações.add("VB38");
        subSubTemp.ações.add("VB34");
        subSubTemp.ações.add("VB44");
        subSubTemp.ownDecreto = subTemp.ownDecreto;
        subTemp.subFerramentas.add(subSubTemp);
        ...
        subSubTemp.ações.add("ID2");
        subSubTemp.ações.add("ID3");
        subSubTemp.ações.add("ID5");
        subSubTemp.ações.add("ID8");
        subSubTemp.ações.add("ID1");
        subSubTemp.ownDecreto = subTemp.ownDecreto;
        subTemp.subFerramentas.add(subSubTemp);
        ...
        subSubTemp.ações.add("TA2");
        subSubTemp.ações.add("TA3");
        subSubTemp.ações.add("TA6");
        subSubTemp.ações.add("TA10");
        subSubTemp.ações.add("TA1");
        subSubTemp.ownDecreto = subTemp.ownDecreto;
        subTemp.subFerramentas.add(subSubTemp);
        ...
        subSubTemp.ações.add("E44");
        subSubTemp.ações.add("E43");
        subSubTemp.ações.add("E41");
        subSubTemp.ações.add("E36");
        subSubTemp.ações.add("E45");
        subSubTemp.ownDecreto = subTemp.ownDecreto;
        subTemp.subFerramentas.add(subSubTemp);
        ...
        subSubTemp.ações.add("IG2");
        subSubTemp.ações.add("IG3");
        subSubTemp.ações.add("IG5");
        subSubTemp.ações.add("IG11");
        subSubTemp.ações.add("IG1");
        subSubTemp.ownDecreto = subTemp.ownDecreto;
        subTemp.subFerramentas.add(subSubTemp);
        ...
        subSubTemp.ações.add("B66");
        subSubTemp.ações.add("B65");
        subSubTemp.ações.add("B60");
        subSubTemp.ações.add("B54");
        subSubTemp.ações.add("B67");
        subSubTemp.ownDecreto = subTemp.ownDecreto;
        subTemp.subFerramentas.add(subSubTemp);

        temp.subFerramentas.add(subTemp);

        subTemp = new SubFerramenta(temp, "Sedação das Funções Yang");
        subTemp.ownDecreto = "Na divina presença do Eu Sou de (nome do terapeuta) abro a frequência do método de Cura Quântica Multidimensional e a Matriz dos Meridianos Energéticos com a função de sedar as funções Yang pedindo ao Eu Superior de (nome do consulente) permissão para atuar nos seus campos, chakras e corpos sutis. Ativo agora a frequência do ponto (ponto) na localização (localização). Que pulsem na harmonia e alinhamento de consciência de (nome do consulente) na quantidade certa e na medida exata. Pulsa no campo, pulsa no campo, pulsa no campo";
